...
if auth.authorized:
    ...
    # Policy denied — show the human-readable
    # reasons + suggestions. (`auth.denial_trace` carries
    # the full DenialTrace proto with reason codes and
    # source locations if you need the structured form.)
